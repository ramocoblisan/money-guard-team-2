  ...
  extraReducers: builder => {
    builder
      .addCase(fetchTransactionsDataThunk.fulfilled, (state, { payload }) => {
        ...
        state.totalAmount = payload.reduce((sum, transaction) => sum + transaction.amount, 0); // Recalculare totalAmount
        state.loading = false;
      })
      .addCase(deleteTransactionThunk.fulfilled, (state, { payload }) => {
        ...
        state.totalAmount -= payload.amount; // Actualizare totalAmount
        state.loading = false;
      })
      ...
      .addCase(editTransactionThunk.fulfilled, (state, { payload }) => {
        ...
        state.totalAmount = state.transactionsList.reduce((sum, transaction) => sum + transaction.amount, 0); // Recalculare totalAmount
        state.loading = false;
      })
      .addCase(
...
export const selectTotalAmount = state => state.transactions.totalAmount; // Selector pentru totalAmount
